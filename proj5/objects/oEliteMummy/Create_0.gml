...
var _chase_behave = new TaskChaseInstance(obj_player_main, 1.8, 400, 250);
var _succeder = new BTreeSucceeder();
var _spell_1 = new TaskSpell1(obj_player_main, 0.2*60);
var _spell_2 = new TaskSpell2(obj_player_main, 1*60);
var _check_spell_2 = new TaskCheckSpell(obj_player_main, 4 );
var _sequence_spell_2 = new BTreeSequence();
var _check_spell_tornado = new TaskCheckSpell(obj_player_main, 6);
var _spell_tornado = new TaskSpellTornado(obj_player_main, 1*60);
